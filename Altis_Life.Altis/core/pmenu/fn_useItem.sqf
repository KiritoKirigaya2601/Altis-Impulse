...
switch (true) do {
	case (_item in ["waterBottle","coffee","redgull","Milkshake","tea"]): {
	...
	case (_item in ["apple","rabbit","pizza","ribs","salema","pizza","ribs","Milkshake","chowmein","kebab","fishchips","ornate","mackerel","tuna","mullet","catshark","turtlesoup","hen","rooster","sheep","goat","donuts","tbacon","peach"]): {
