...
class Clothing {
    class bruce {
        ...
        uniforms[] = {
            ...
            { "U_C_Poloshirt_blue", "Big Bang Theory", 250, { "", "", -1 } },
            { "U_C_Poloshirt_burgundy", "Simpsons", 250, { "", "", -1 } },
            { "U_C_Poloshirt_stripped", "Dexter", 250, { "", "", -1 } },
            { "U_C_Poloshirt_tricolour", "Dr.Who (UK)", 250, { "", "", -1 } },
            { "U_C_Poloshirt_salmon", "Dr.Who (Dalek)", 250, { "", "", -1 } },
            { "U_C_Poloshirt_redwhite", "American Horror Story", 250, { "", "", -1 } },
            { "U_C_Commoner1_1", "Futurama", 250, { "", "", -1 } },
            { "U_C_Commoner1_2", "AltisImpulse Official", 250, { "", "", -1 } },
            { "U_C_Commoner1_3", "Panda", 250, { "", "", -1 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
    ...
    class cop {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
			{ "U_O_OfficerUniform_ocamo", "Cop Uniform", 0, { "life_coplevel", "SCALAR", 1 } }
        ...
        vests[] = {
            ...
            { "V_PlateCarrier2_rgr", "", 0, { "life_coplevel", "SCALAR", 6 } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "", "", -1 } },
            { "B_Kitbag_cbr", "", 0, { "", "", -1 } },
            ...
            { "B_Bergen_sgg", "", 0, { "", "", -1 } },
            { "B_Carryall_cbr", "", 0, { "", "", -1 } },
            { "B_UAV_01_backpack_F", "", 0, { "life_coplevel", "SCALAR", 5 } }
        };
    };
