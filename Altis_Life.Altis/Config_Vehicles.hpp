    ...
    */
    ...
    class med_air_hs {
        ...
        vehicles[] = {
            ...
            { "I_Heli_Transport_02_F", 50000, { "mAir" }, { "", "", -1 } }
        };
    };
    ...
    class civ_truck {
        ...
        vehicles[] = {
            ...
            { "B_Truck_01_fuel_F", 40000, { "trucking" }, { "", "", -1 } },
            { "O_G_Van_01_fuel_F", 20000, { "trucking" }, { "", "", -1 } }
        };
    };
    ...
    class reb_car {
        ...
        vehicles[] = {
            ...
            { "I_MRAP_03_hmg_F", 8000000, { "rebel" }, { "", "", -1 } }
        };
    };
    ...
    class cop_car {
        ...
        vehicles[] = {
            ...
            { "I_MRAP_03_F", 0, { "" }, { "life_coplevel", "SCALAR", 8 } },
            { "C_Hatchback_01_F", 0, { "" }, { "life_coplevel", "SCALAR", 2 } },
            { "B_MRAP_01_F", 0, { "" }, { "life_coplevel", "SCALAR", 3 } }
        };
    };
    ...
    class civ_air {
        ...
        vehicles[] = {
            ...
            { "I_Heli_Transport_02_F", 250000, { "pilot" }, { "", "", -1 } }
        };
    };
    ...
    class cop_airhq {
        ...
        vehicles[] = {
            ...
            { "I_Heli_light_03_unarmed", 0, { "" }, { "life_coplevel", "SCALAR", 3 } },
            { "B_Heli_Transport_03_unarmed_F", 0, { "" }, { "life_coplevel", "SCALAR", 3 } }
        };
    };
...
class LifeCfgVehicles {
    ...
    */
    ...
    class C_Offroad_01_F {
        ...
        textures[] = {
            { "Police", "cop", {
                    "textures\police\met_police_offroader.jpg"
            } },
            { "Hello Kitty", "civ", {
                    "textures\civ\hellokitty.jpg"
            } },
            { "Red Texture Stripe", "civ", {
                    "textures\civ\CIV_OFF3.jpg"
            } },
            { "Red", "civ", {
    ...
    class C_Hatchback_01_sport_F {
        ...
        textures[] = {
            { "Monster", "civ", {
                "textures\civ\civ_monsterwrc_hb.jpg"
            } },
            { "Unicorn", "civ", {
                "textures\civ\unicorn_hatchback.jpg"
            } },
            { "Blue", "cop", {
                "textures\police\lincpol_hbsport.jpg"
            } },
            { "Silver", "cop", {
                "textures\police\met_police_hatchback.jpg"
            } },
            { "White", "cop", {
                "textures\police\manpol_hatchback.jpg"
            } },
            { "AHS", "med", {
                "textures\medic\paramedic_hb.jpg"
            } }
        };
    };
    ...
    class C_SUV_01_F {
        ...
        textures[] = {
             { "Speed Freak", "civ", {
                "textures\civ\Speed-Freak.jpg"
            } },
            { "Blue Camo", "civ", {
                "textures\civ\suv_bluecamo.jpg"
            } },
             { "Dark Red", "civ", {
            ...
            { "white", "cop", {
                "textures\police\met_police_suv_white.jpg"
            } },
            { "AHS", "med", {
                "textures\medic\paramedic_suv.jpg"
            } }
        };
    };
    ...
    class B_MRAP_01_F {
        ...
        textures[] = {
            { "Blue", "cop", {
                "textures\police\met_police_hunter_front.jpg","textures\police\met_police_hunter_back.jpg"
            } },
            { "White", "cop", {
                "textures\police\scotpol_Hunter_Cab.jpg","textures\police\scotpol_Hunter_Back.jpg"
            } },
            { "Black", "fed", {
                "#(argb,8,8,3)color(0.05,0.05,0.05,1)"
            } }
    ...
    class O_Heli_Light_02_unarmed_F {
        ...
        textures[] = {
            ...
            { "AHS", "med", {
                "textures\medic\paramedic_hems.jpg"
            } }
        };
    };
